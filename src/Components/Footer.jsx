...
const Footer = () => {
  ...
  <nav className="text-gray-500">
    ...
    <a className="link link-hover">Mission & Vision</a>
    <a className="link link-hover">Employee Portalt</a>
  </nav>
  <nav className="text-gray-500">
    <h6 className="footer-title opacity-100 text-black text-lg  ">About Us</h6>
    <a className="link link-hover">Who We Are</a>
    <a className="link link-hover">Team Paradox</a>
    <a className="link link-hover">Work With Us</a>
    <a className="link link-hover">Refund and <br /> Cancellation</a>
  </nav>
  <nav className="text-gray-500">

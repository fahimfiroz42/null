...
const Footer = () => {
    return (
        <div className="bg-secondary dark:bg-slate-800">
            <footer className="footer bg-secondary dark:bg-slate-800 w-11/12 mx-auto py-10">
  <aside>
    ...
    <h6 className="footer-title opacity-100 text-black    ">Social Links</h6>
  ...
  <nav className="text-gray-500">
    ...
    <Link to={'/contactUs'} className="link link-hover">Employee Portalt</Link>
  </nav>
  <nav className="text-gray-500">
